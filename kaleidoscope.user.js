...
var Kaleidoscope = {
    ...
    loadFrame : function() {
        ...
        // if(localStorage.getItem(html_prefix + 'xpos')) {
        //    container.style.top = localStorage.getItem(html_prefix + 'ypos');
        //    container.style.left = localStorage.getItem(html_prefix + 'xpos');
        // }
